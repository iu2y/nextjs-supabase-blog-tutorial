      ...
      <form onSubmit={onSubmit}>
        <div className="mb-5">
          <div className="flex justify-center mb-5">
            <Image
              src={avatarUrl ? avatarUrl : '/image1.jpg'}
        ...
        <div className="mb-5">
          ...
          <input
            className="w-full bg-gray-100 rounded border py-1 px-3 outline-none foucus:bg-transparent focus:ring-2 focus:ring-yellow-500"
            ref={nameRef}
            type="text"
            id="name"
            placeholder="Name"
